...
const webState = {
  ...
  about: "View admission details and monthly fees structure for Junior Basic section.",
  description2: "We welcome young learners to begin their educational journey with us.",
};
...
const admissionProcess = [
  ...
  },
  {
    ...
    description: "Submit required documents including birth certificate and photographs.",
  },
  {
    step: "3",
    title: "Interaction Session",
    description: "Child and parent interaction session to understand the child's needs.",
  },
  {
    step: "4",
...
const classAdmissions = [
  { class: "Pre-Primary", age: "3-4 years", seats: "25 per class", requirements: "Birth certificate, Medical certificate" },
  { class: "I - II", age: "5-7 years", seats: "30 per class", requirements: "Birth certificate, Previous school records (if any)" },
  { class: "III - V", age: "8-10 years", seats: "30 per class", requirements: "Transfer certificate, Previous year marksheet" },
];

const feeStructure = [
  { class: "Pre-Primary", admission: "₹1,500", monthly: "₹1,200", annual: "₹14,400", other: "₹2,500" },
  { class: "I - II", admission: "₹1,800", monthly: "₹1,300", annual: "₹15,600", other: "₹3,000" },
  { class: "III - V", admission: "₹2,000", monthly: "₹1,500", annual: "₹18,000", other: "₹3,500" },
];
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
              {admissionProcess.map((process, index) => (
                ...
                >
                  <div className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-[var(--primary-soft,rgba(249,115,22,0.12))] flex items-center justify-center mb-3 md:mb-4">
                    <span className="text-lg md:text-xl font-bold text-[var(--primary,#f97316)]">{process.step}</span>
                  </div>
          ...
          <div>
            <div className="text-center mb-8 md:mb-12">
              <div className="inline-flex items-center gap-2 mb-4">
                <FaRupeeSign className="w-6 h-6 md:w-8 md:h-8 text-[var(--primary,#f97316)]" />
            ...
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
              <div className="overflow-x-auto">
                <table className="min-w-full divide-y divide-gray-200">
                  <thead className="bg-[var(--primary,#f97316)]">
                    <tr>
              ...
              <div className="bg-gray-50 px-6 py-4 border-t border-gray-200">
                <p className="text-xs text-gray-600">
                  <strong>Note:</strong> Other charges include activity fee, library fee, sports fee, and development fund. 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-8">
            ...
            <div>
              <div className="bg-gray-50 rounded-2xl p-4 md:p-8">
                <div className="flex items-center gap-3 mb-4 md:mb-6">
                  <FileText className="w-6 h-6 md:w-8 md:h-8 text-[var(--primary,#f97316)]" />
                  <h2 className="text-xl md:text-2xl font-extrabold">Required Documents</h2>
                </div>
                <ul className="space-y-2 md:space-y-3">
                  {requiredDocuments.map((doc, index) => (
                    <li key={index} className="flex items-start gap-3">
                      <CheckCircle className="w-4 h-4 md:w-5 md:h-5 text-[var(--primary,#f97316)] mt-0.5 flex-shrink-0" />
            ...
            <div>
              <div className="bg-gray-50 rounded-2xl p-4 md:p-8">
                <div className="flex items-center gap-3 mb-4 md:mb-6">
                  <Calendar className="w-6 h-6 md:w-8 md:h-8 text-[var(--primary,#f97316)]" />
            ...
            <div className="bg-white rounded-2xl p-4 md:p-8 shadow-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
                <div className="flex items-start gap-3 md:gap-4">
                  <div className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-[var(--primary-soft,rgba(249,115,22,0.12))] flex items-center justify-center flex-shrink-0">
                    <Phone className="w-5 h-5 md:w-6 md:h-6 text-[var(--primary,#f97316)]" />
                  </div>
                  <div>
                ...
                <div className="flex items-start gap-3 md:gap-4">
                  <div className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-[var(--primary-soft,rgba(249,115,22,0.12))] flex items-center justify-center flex-shrink-0">
                    <Mail className="w-5 h-5 md:w-6 md:h-6 text-[var(--primary,#f97316)]" />
                  </div>
                  <div>
                ...
                <div className="flex items-start gap-3 md:gap-4">
                  <div className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-[var(--primary-soft,rgba(249,115,22,0.12))] flex items-center justify-center flex-shrink-0">
                    <MapPin className="w-5 h-5 md:w-6 md:h-6 text-[var(--primary,#f97316)]" />
                  </div>
                  <div>
              ...
              <div className="mt-6 md:mt-8 text-center">
                <button className="inline-flex items-center gap-2 rounded-full bg-[var(--primary,#f97316)] px-4 md:px-6 py-2 md:py-3 text-xs md:text-sm font-semibold text-white shadow-md hover:opacity-95 transition">
