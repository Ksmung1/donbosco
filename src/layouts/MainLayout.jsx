...
const MainLayout = () => {
  const states = [
    {
      state: "hs",
      image:
        getImageFromGallery("donbosco.avif") || getImageFromGallery("donbosco"),
      label: "HSLC",
    },
    {
      state: "hr",
      image:
        getImageFromGallery("corridor.avif") || getImageFromGallery("corridor"),
      label: "HR",
    },
    {
      state: "jb",
      image:
        getImageFromGallery("garden.avif") || getImageFromGallery("garden"),
      label: "JB",
    },
  ];
  ...
  const currentTheme = useMemo(
    () => themeByState[state] || themeByState.hs,
    [state]
  );
  ...
  return (
    ...
    >
      ...
      {admissionNotice.enabled && showAdmissionNotice && (
        <div className="fixed bottom-12 right-4 z-40 max-w-[300px]">
          <div
          ...
          >
            <div className="flex items-start gap-3">
              <div className="flex-1">
                <div className="text-sm flex items-center gap-2 font-semibold text-blue-800">
                ...
                <div className="mt-3 flex items-center gap-2">
                  <Link
                    ...
                    className="inline-flex items-center justify-center rounded-full px-3 py-2 text-xs font-semibold text-white shadow transition bg-blue-800"
                  >
                    {admissionNotice.cta}
                  </Link>
                  <button
