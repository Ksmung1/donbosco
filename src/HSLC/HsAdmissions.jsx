...
const classAdmissions = [
  { class: "I - V", seats: "30 per class", requirements: "Birth certificate, Previous school records" },
  { class: "VI - VIII", seats: "35 per class", requirements: "Transfer certificate, Previous year marksheet" },
  { class: "IX - X", seats: "40 per class", requirements: "Transfer certificate, Class VIII marksheet" },
  { class: "XI - XII", seats: "45 per class", requirements: "HSLC marksheet, Transfer certificate" },
];

const feeStructure = [
  { class: "I - V", admission: "₹2,000", monthly: "₹1,500" },
  { class: "VI - VIII", admission: "₹2,500", monthly: "₹1,800" },
  { class: "IX - X", admission: "₹3,000", monthly: "₹2,000" },
  { class: "XI - XII", admission: "₹3,500", monthly: "₹2,200" },
];
  ...
  return (
    <div className="text-gray-900">
      ...
      <section className="bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20 grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
          <div className="text-center lg:text-left space-y-4">
            ...
            <h1 className="text-3xl md:text-5xl font-extrabold tracking-tight">{webState.title}</h1>
            <p className="text-xs md:text-base text-gray-600 max-w-2xl mx-auto lg:mx-0">{webState.about}</p>
            <p className="text-xs md:text-base text-gray-600 max-w-2xl mx-auto lg:mx-0">{webState.description2}</p>
          </div>
          <div className="rounded-2xl bg-(--primary-soft,rgba(5,150,105,0.08)) p-6 md:p-8 shadow-sm text-center lg:text-left">
            <h2 className="text-xl md:text-2xl font-bold text-(--primary,#059669)">Why Don Bosco Admissions</h2>
            <p className="mt-2 text-sm md:text-base text-gray-700">
              Clear steps, supportive staff, and a transparent fee structure so families can plan with confidence.
            </p>
            <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm text-gray-800">
              <div className="p-3 rounded-xl bg-white shadow-sm border border-gray-100">Guided application support</div>
              <div className="p-3 rounded-xl bg-white shadow-sm border border-gray-100">Transparent fee plans</div>
              <div className="p-3 rounded-xl bg-white shadow-sm border border-gray-100">Quick document checklist</div>
              <div className="p-3 rounded-xl bg-white shadow-sm border border-gray-100">Dedicated parent helpdesk</div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div>
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-5xl font-extrabold tracking-tight">Admission Process</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {admissionProcess.map((process, index) => (
                ...
                >
                  <div className="w-10 md:w-12 h-10 md:h-12 rounded-full bg-(--primary-soft,rgba(5,150,105,0.08)) flex items-center justify-center mb-1 md:mb-4">
                    <span className="text-xl font-bold text-(--primary,#059669)">{process.step}</span>
                  </div>
                      ...
                      {classAdmissions.map((item, index) => (
                        <tr key={index} className="hover:bg-gray-50 transition">
                          ...
                          <td className="px-6 py-4 ">
                            <div className="text-xs md:text-sm text-gray-600">{item.requirements}</div>
                          </td>
                        </tr>
                      ))}
                    </tbody>
          ...
          <div>
            <div className="text-center mb-12">
              <div className="inline-flex items-center gap-2 mb-4">
                <FaRupeeSign className="w-8 h-8 text-(--primary,#059669)" />
              ...
              <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
                <div className="overflow-x-auto">
                  <table className="min-w-full divide-y divide-gray-200">
                    <thead className="bg-(--primary,#059669)">
                      <tr>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div>
              <div className="bg-gray-50 rounded-2xl p-8">
                  ...
                  <FileText className="w-8 h-8 text-(--primary,#059669)" />
                  <h2 className="text-2xl font-bold">Required Documents</h2>
                </div>
                <ul className="space-y-3">
                  {requiredDocuments.map((doc, index) => (
                    <li key={index} className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-(--primary,#059669) mt-0.5 shrink-0" />
            ...
            <div>
              <div className="bg-gray-50 rounded-2xl p-8">
                    <div className="flex items-center gap-3 mb-6">
                  <Calendar className="w-8 h-8 text-(--primary,#059669)" />
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 rounded-full bg-(--primary-soft,rgba(5,150,105,0.08)) flex items-center justify-center shrink-0">
                    <Phone className="w-6 h-6 text-(--primary,#059669)" />
                  </div>
                  <div>
                ...
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 rounded-full bg-(--primary-soft,rgba(5,150,105,0.08)) flex items-center justify-center shrink-0">
                    <Mail className="w-6 h-6 text-(--primary,#059669)" />
                  </div>
                  <div>
                ...
                <div className="flex items-start gap-4">
                    <div className="w-12 h-12 rounded-full bg-(--primary-soft,rgba(5,150,105,0.08)) flex items-center justify-center shrink-0">
                    <MapPin className="w-6 h-6 text-(--primary,#059669)" />
                  </div>
                  <div>
              ...
              <div className="mt-8 text-center">
                <button className="inline-flex items-center gap-2 rounded-full bg-(--primary,#059669) px-6 py-3 text-sm font-semibold text-white shadow-md hover:opacity-95 transition">
