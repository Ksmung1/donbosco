  ...
  return (
    ...
    >
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
              <div>
                ...
                <p className="mt-4 text-gray-600 max-w-xl">{managementState.subtitle}</p>
                <p className="mt-4 text-gray-600 max-w-xl">{managementState.intro}</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SlideIn direction="up" delay={0.04}>
            ...
            <div className="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
              {boardMembers.map((m) => (
                <div key={m.name} className="rounded-2xl bg-white p-6 shadow-sm flex gap-4 items-start">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SlideIn direction="up" delay={0.04}>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              <div>
                <h3 className="text-2xl font-bold mb-4">Committees</h3>
                <div className="space-y-4">
                  {committees.map((c) => (
                    <div key={c.title} className="p-4 border rounded-2xl bg-gray-50">
              ...
              <div>
                <h3 className="text-2xl font-bold mb-4">Key Policies</h3>
                <div className="space-y-4">
                  {policies.map((p) => (
                    <div key={p.title} className="p-4 border rounded-2xl">
                      <div className="font-semibold">{p.title}</div>
                      <div className="text-sm text-gray-600 mt-1">{p.summary}</div>
                    </div>
                  ))}
                </div>
              </div>
          ...
          <SlideIn direction="up" delay={0.04}>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-start">
              <div className="md:col-span-2">
                <h2 className="text-3xl font-bold mb-4">Contact & Office Hours</h2>
                ...
                <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="p-4 bg-white rounded-2xl shadow-sm">
                    <div className="flex items-center gap-3">
                      <Phone className="w-5 h-5 text-[var(--primary,#059669)]" />
                      <div>
                  ...
                  <div className="p-4 bg-white rounded-2xl shadow-sm">
                    <div className="flex items-center gap-3">
                      <FileText className="w-5 h-5 text-[var(--primary,#059669)]" />
                      <div>
                  ...
                  <div className="p-4 bg-white rounded-2xl shadow-sm">
                    <div className="flex items-center gap-3">
                      <Calendar className="w-5 h-5 text-[var(--primary,#059669)]" />
                      <div>
                  ...
                  <div className="p-4 bg-white rounded-2xl shadow-sm">
                    <div className="flex items-center gap-3">
                      <UserCheck className="w-5 h-5 text-[var(--primary,#059669)]" />
                      <div>
                        <div className="text-sm font-medium">Office</div>
                        <div className="text-sm text-gray-600">{contact.office}</div>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <section className="bg-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SlideIn direction="up" delay={0.04}>
            <h2 className="text-3xl font-bold mb-6">Meetings & Minutes</h2>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="rounded-2xl bg-gray-50 p-6">
                <div className="text-lg font-semibold">Annual Board Meeting</div>
                <div className="text-sm text-gray-600 mt-2">Summary of strategic priorities and budget approvals.</div>
              </div>

              <div className="rounded-2xl bg-gray-50 p-6">
                <div className="text-lg font-semibold">Academic Council</div>
                <div className="text-sm text-gray-600 mt-2">Curriculum review, assessment review and teacher development.</div>
              </div>

              <div className="rounded-2xl bg-gray-50 p-6">
                <div className="text-lg font-semibold">Safety & Welfare</div>
                <div className="text-sm text-gray-600 mt-2">Student welfare initiatives, drills and safeguarding updates.</div>
              </div>
            </div>
          </SlideIn>
        </div>
      ...
      <section className="bg-gray-50 py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <SlideIn direction="up" delay={0.05}>
            <h2 className="text-2xl font-bold">Want to meet the team?</h2>
            <p className="mt-3 text-gray-600">Request a meeting with the admin office or visit during office hours.</p>

            <div className="mt-6 flex items-center justify-center gap-4">
              <a
                href={`mailto:${contact.email}`}
                className="inline-flex items-center bg-[var(--primary,#059669)] text-white px-6 py-2 rounded-full font-medium shadow hover:opacity-95 transition"
                style={{ background: "var(--primary)" }}
              >
                Email Admin
              </a>
              ...
              <a
                ...
                className="inline-flex items-center border border-gray-200 px-6 py-2 rounded-full text-gray-700 hover:bg-gray-50 transition"
              >
                Call Office
              </a>
            </div>
