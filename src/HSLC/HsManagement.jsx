              ...
              <div className="md:col-span-2">
                ...
                <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4">
                    ...
                    <div className="flex items-center gap-3">
                      <Phone className="w-4 h-4 md:w-5 md:h-5 text-(--primary,#059669) shrink-0" />
                      <div>
                  ...
                  <div className="p-3 md:p-4 bg-white rounded-2xl shadow-sm">
                    <div className="flex items-center gap-3">
                      <FileText className="w-4 h-4 md:w-5 md:h-5 text-(--primary,#059669) shrink-0" />
                      <div>
                  ...
                  <div className="p-3 md:p-4 bg-white rounded-2xl shadow-sm">
                    <div className="flex items-center gap-3">
                      <Calendar className="w-4 h-4 md:w-5 md:h-5 text-(--primary,#059669) shrink-0" />
                      <div>
                  ...
                  <div className="p-3 md:p-4 bg-white rounded-2xl shadow-sm">
                    <div className="flex items-center gap-3">
                      <UserCheck className="w-4 h-4 md:w-5 md:h-5 text-(--primary,#059669) shrink-0" />
                      <div>
          ...
          <h2 className="text-2xl md:text-5xl font-extrabold">Want to meet the team?</h2>
            ...
            <div className="mt-6 flex items-center justify-center gap-3 md:gap-4">
              <a
                ...
                className="inline-flex items-center bg-(--primary,#059669) text-white px-4 md:px-6 py-2 rounded-full text-xs md:text-sm font-medium shadow hover:opacity-95 transition"
                style={{ background: "var(--primary)" }}
              >
                Email Admin
              </a>
